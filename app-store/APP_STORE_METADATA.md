...
**Promotional text:** Turn a photo, PDF or plain-language work schedule into a realistic week of shifts, workouts, meals, recovery, tasks and reminders.
...
Add your work schedule from a photo, PDF or plain text. Review every item before saving, then let the planner organize workouts, meals, recovery, errands and reminders around the time you actually have.

BUILT FOR REAL WORK SCHEDULES

• Import schedule photos and PDFs or paste raw schedule text
...
2. Complete or skip the six-step adaptive plan.
