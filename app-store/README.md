...
This is the canonical native release source for the current Work + Workout product. It bundles the reviewed v30.1.31 web application inside Capacitor and adds native status-bar handling, splash behavior, haptics, local notifications, read-only HealthKit/Health Connect step totals, Android back navigation, OAuth browser presentation, and native file sharing.
