...
This is the canonical native release source for the current Work + Workout product. It bundles the reviewed v30.1.1 web application inside Capacitor and adds native status-bar handling, splash behavior, haptics, local notifications, Android back navigation, OAuth browser presentation, and native file sharing.
...
- The same v30.1.1 landing page, account lifecycle and adaptive onboarding as production.
