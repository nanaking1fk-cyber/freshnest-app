...
if(!/30\.1\.28/.test(index))errors.push('Current production version missing from native index');
...
console.log('Native bundle audit passed: v30.1.28 is self-contained, the stale PWA runtime is disabled, production APIs are explicit, native capabilities are present, and no server secrets were detected.');
