...
html=rewrite(
  ...
  "h=h.replace('<head>','<head><base href=\"../work-gym-planner-v15/\"><scr'+'ipt defer src=\"../native/native-bridge.js?v=30.1.31\"></scr'+'ipt><scr'+'ipt defer src=\"../shared/observability.js?v=30.1.31-crash53\"></scr'+'ipt>');",
