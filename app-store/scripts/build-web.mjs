...
html=rewrite(
  ...
  "h=h.replace('<head>','<head><base href=\"../work-gym-planner-v15/\"><scr'+'ipt defer src=\"../native/native-bridge.js?v=30.0.8\"></scr'+'ipt>');",
  'load native bridge first'
);
html=html.replace("'pwa-patch.js',",'');
html=html.replace("h=h.replace('<link rel=\"manifest\" href=\"./manifest.webmanifest\">','<link rel=\"manifest\" href=\"../work-gym-planner/manifest.webmanifest?v=30.0.8\">');","h=h.replace(/<link rel=\"manifest\"[^>]*>/g,'');");
...
console.log(`Built Work + Workout 30.0.8 native web bundle: ${out}`);
