...
test('diagnostic endpoint persists only sanitized, fingerprinted reports',async()=>{
  ...
  const req={method:'POST',url:'/api/v18/client-error',headers,socket:{},body:{source:'window_error',category:'client',release:'30.1.30',surface:'web',route:'/work-gym-planner/?email=john@example.com',errorName:'TypeError',message:'Failed for john@example.com token=secret',stack:'at run (https://www.workandworkout.com/app.js?token=secret:1:2)'}};
  let responseBody='';
