...
test('portion controls and calculation module load in production, offline and native source',()=>{
 ...
 for(const file of ['work-gym-planner/boot.js','work-gym-planner/index.html','work-gym-planner/sw.js','work-gym-planner-v16/sw.js','work-gym-planner-v16/pwa-patch.js'])assert.ok(read(file).includes('30.1.31-shifts75'),file);
});
