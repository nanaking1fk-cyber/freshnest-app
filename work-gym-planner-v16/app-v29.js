...
(function workWorkoutAppV29(window){
  ...
  function normalizeBrand(){
    ...
    var about=document.querySelector('#aboutDialog .card p');if(about&&about.innerHTML.includes('Version:'))about.innerHTML='<b>Version:</b> 30.1.8';
  }
