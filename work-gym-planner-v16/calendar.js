...
function renderCalendar(){
 ...
 let legend=document.querySelector('#page-calendar .legend');if(legend)legend.innerHTML='<span><i class="dot blue"></i>Work</span><span><i class="dot green"></i>Training</span><span><i class="dot purple"></i>Plans &amp; to-do</span><span><i class="dot gray"></i>Needs review</span>';
 ...
 for(let n=1;n<=days;n++){
  ...
  let dots='<span class="dayDots">'+(workRows.some(row=>!row.unknown)?'<i class="dot blue"></i>':'')+(gym?'<i class="dot green"></i>':'')+(agenda.length?'<i class="dot purple"></i>':'')+(s.kind==='unknown'?'<i class="dot gray"></i>':'')+'</span>';
