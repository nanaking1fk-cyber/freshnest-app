...
function addCommercialProductUI(){
 ...
 let top=$('.topbar h1');if(top)top.textContent='Work + Gym Coach';let about=$('#aboutDialog h2');if(about)about.textContent='About Work + Gym Coach';document.title='Work + Gym Coach';
}
