...
(function setupV16Shell(){
 ...
 const about=document.querySelector('#aboutDialog .card');if(about)about.innerHTML='<p><b>Version:</b> 30.1.15</p><p>Adaptive work, recovery, training and nutrition planning with private account sync and review-before-save schedule intake.</p><p>Apple Health files are parsed locally. Direct HealthKit access is not available to Safari/PWA apps.</p>';
})();
