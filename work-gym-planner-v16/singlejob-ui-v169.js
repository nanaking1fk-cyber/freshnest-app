// v16.9: make optional workday workouts explicit throughout the calendar UI.
...
renderCalendar=function(){
 ...
 if(legend&&!legend.querySelector('.singleJobLegend'))legend.insertAdjacentHTML('beforeend','<span class="singleJobLegend"><i class="dot blue"></i>Optional workout</span>');
};
...
renderDayCard=function(){
 ...
 if(singleJobWorkoutAvailable(k)&&!isScheduled(k)){
  ...
  if(pills[1]){pills[1].textContent='Optional workout · '+name;pills[1].classList.add('good')}
