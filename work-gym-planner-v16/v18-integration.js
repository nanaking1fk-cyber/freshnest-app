...
(function(){
 function upgrade(){
  ...
  let about=$('#aboutDialog .card');if(about)about.innerHTML='<p><b>Version:</b> 21.0 Product Story Edition</p><p>An autoplay day-in-the-life hero demonstrates Work + Workout in use: a shift-aware plan, live schedule adaptation, workout logging, meal logging and Progressive Coach guidance. Quick Plan, contextual reminders, private per-account data, adaptive calendars, nutrition and multimodal AI Coach remain connected.</p><p>Your account data is isolated per user. Equipment photos are used for the requested AI answer and are not stored in the app chat history.</p>';
