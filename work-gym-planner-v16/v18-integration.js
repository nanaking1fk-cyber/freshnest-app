...
(function(){
 function upgrade(){
  ...
  let about=$('#aboutDialog .card');if(about)about.innerHTML='<p><b>Version:</b> 18.1.0</p><p>Personal accounts, cloud migration, schedule-aware onboarding, personalized nutrition, workout library and multimodal AI Coach.</p><p>Your account data is isolated per user. Equipment photos are used for the requested AI answer and are not stored in the app chat history.</p>';
