...
(function(){
 function upgrade(){
  ...
  let about=$('#aboutDialog .card');if(about)about.innerHTML='<p><b>Version:</b> 20.0 Cinematic Edition</p><p>A worker-first landing story with real moving footage, a 26-second cinematic product film, natural-language Quick Plan, contextual reminders, private per-account data, adaptive work and workout calendars, nutrition and multimodal AI Coach.</p><p>Your account data is isolated per user. Equipment photos are used for the requested AI answer and are not stored in the app chat history.</p>';
