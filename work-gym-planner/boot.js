(async()=>{try{
  ...
  let h=await fetch('../work-gym-planner-v15/index.html?v=30.1.31',{cache:'no-store'}).then(r=>{if(!r.ok)throw Error('base');return r.text()});
  ...
  const assetRevision='30.1.31-legal1';
