(async()=>{try{
  ...
  let h=await fetch('../work-gym-planner-v15/index.html?v=30.1.31-privacy52',{cache:'force-cache'}).then(r=>{if(!r.ok)throw Error('base');return r.text()});
