(async()=>{try{
  ...
  let h=await fetch('../work-gym-planner-v15/index.html?v=30.1.26',{cache:'no-store'}).then(r=>{if(!r.ok)throw Error('base');return r.text()});
  ...
  h=h.replace('<link rel="manifest" href="./manifest.webmanifest">','<link rel="manifest" href="../work-gym-planner/manifest.webmanifest?v=30.1.26">');
  h=h.replace('<link rel="icon" href="./icons/icon-192.png" type="image/png">','<link rel="icon" type="image/svg+xml" href="../work-gym-planner-v16/icons/icon.svg?v=30.1.26">');
  h=h.replace('<link rel="apple-touch-icon" sizes="180x180" href="./icons/icon-180.png">','<link rel="apple-touch-icon" sizes="180x180" href="../work-gym-planner-v16/icons/icon-180.png?v=30.1.26">');
  h=h.replace('</head>','<link rel="stylesheet" href="../work-gym-planner/boot.css?v=30.1.26"><link rel="stylesheet" href="../work-gym-planner-v16/v16.css?v=30.1.26"><link id="premiumV18Styles" rel="stylesheet" href="../work-gym-planner-v16/premium-v18.css?v=30.1.26"><link rel="stylesheet" href="../work-gym-planner-v16/landing-v29.css?v=30.1.26"><link rel="stylesheet" href="../work-gym-planner-v16/home-v27.css?v=30.1.26"><link rel="stylesheet" href="../work-gym-planner-v16/nutrition-v27.css?v=30.1.26"><link rel="stylesheet" href="../work-gym-planner-v16/adaptive-planner-v24.css?v=30.1.26"><link rel="stylesheet" href="../work-gym-planner-v16/schedule-platform-v25.css?v=30.1.26"><link rel="stylesheet" href="../work-gym-planner-v16/app-v29.css?v=30.1.26"><link rel="stylesheet" href="../work-gym-planner-v16/app-v30.css?v=30.1.26"></head>');
  const p='../work-gym-planner-v16/';
  const assetRevision='30.1.26-legal1';
  const platformScripts='<scr'+'ipt defer src="../shared/v23-core.js?v=30.1.26"></scr'+'ipt><scr'+'ipt defer src="../shared/v25-scheduling.js?v=30.1.26"></scr'+'ipt><scr'+'ipt defer src="../shared/v31-roster.js?v=30.1.26"></scr'+'ipt>';
