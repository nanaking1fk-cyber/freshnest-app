(async()=>{try{
  ...
  h=h.replace('app-v30.css?v=30.1.31-free57-hours58','app-v30.css?v=30.1.31-profile77');
  const assetRevision='30.1.31-profile77',accountRevision='30.1.31-account80',healthRevision='30.1.31-activity83';
