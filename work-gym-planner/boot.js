(async()=>{try{
  ...
  let h=await fetch('../work-gym-planner-v15/index.html?v=30.1.31-calendar54',{cache:'force-cache'}).then(r=>{if(!r.ok)throw Error('base');return r.text()});
  ...
  h=h.replace('<head>','<head><base href="../work-gym-planner-v15/"><scr'+'ipt defer src="../shared/observability.js?v=30.1.31-calendar54"></scr'+'ipt>');
