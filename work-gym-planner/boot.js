(async()=>{try{
  ...
  let h=await fetch('../work-gym-planner-v15/index.html?v=30.1.31-free57-hours58',{cache:'force-cache'}).then(r=>{if(!r.ok)throw Error('base');return r.text()});
  ...
  const assetRevision='30.1.31-free57-hours58';
