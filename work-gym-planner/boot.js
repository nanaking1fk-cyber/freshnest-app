(async()=>{try{
  ...
  let h=await fetch('../work-gym-planner-v15/index.html?v=30.1.31-readiness62',{cache:'force-cache'}).then(r=>{if(!r.ok)throw Error('base');return r.text()});
  ...
  h=h.replace('app-v30.css?v=30.1.31-free57-hours58','app-v30.css?v=30.1.31-readiness62');
  const assetRevision='30.1.31-readiness62';
  const platformScripts='<scr'+'ipt defer src="../shared/work-pay-v58.js?v=30.1.31-hours58"></scr'+'ipt><scr'+'ipt defer src="../shared/v23-core.js?v=30.1.31-readiness62"></scr'+'ipt><scr'+'ipt defer src="../shared/v25-scheduling.js?v=30.1.31-free57-hours58"></scr'+'ipt><scr'+'ipt defer src="../shared/v31-roster.js?v=30.1.31"></scr'+'ipt>';
