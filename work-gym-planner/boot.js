(async()=>{try{
  ...
  let h=await fetch('../work-gym-planner-v15/index.html?v=30.1.31-account59',{cache:'force-cache'}).then(r=>{if(!r.ok)throw Error('base');return r.text()});
  ...
  h=h.replace('app-v30.css?v=30.1.31-free57-hours58','app-v30.css?v=30.1.31-account59');
  const assetRevision='30.1.31-account59';
